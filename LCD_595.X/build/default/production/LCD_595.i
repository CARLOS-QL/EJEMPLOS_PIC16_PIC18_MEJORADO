...
void LCD_595_cmd(char cmd)
{
 ...
 data_l = ((cmd<<4)&0xf0);
    ...
    SHIFT595_write(data_u|0b0010);
 SHIFT595_write(data_u|0b0000);
 SHIFT595_write(data_l|0b0010);
 SHIFT595_write(data_l|0b0000);
...
void LCD_595_char(char data)
{
 ...
 data_l = ((data<<4)&0xf0);
    ...
    SHIFT595_write(data_u|0b0011);
 SHIFT595_write(data_u|0b0001);
 SHIFT595_write(data_l|0b0011);
 SHIFT595_write(data_l|0b0001);
    _delay((unsigned long)((2)*(16000000/4000.0)));
}
